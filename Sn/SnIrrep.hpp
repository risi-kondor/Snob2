...
public:
  ...
  SnIrrep(const SnIrrepObj *_obj) : obj(_obj), lambda(_obj->lambda) {}
...
public: // Access
  int getn() const { return obj->n; }

  int getd() const { return obj->d; }

  int dim() const { return obj->d; }
...
public:
  ...
  */
  ...
  rtensor JucysMurphy(const int k) { return obj->JucysMurphy(k); }
