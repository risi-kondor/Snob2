...
template <typename GROUP, typename TENSOR> class FourierOnGroup {
public:
...
FourierOnGroup<GROUP, cnine::CtensorObj>
Fourier(const FunctionOnGroup<GROUP, TENSOR> &f) {
  return FourierOnGroup<GROUP, cnine::CtensorObj>(f);
}

template <typename GROUP>
FunctionOnGroup<GROUP, cnine::CtensorObj>
iFourier(const FourierOnGroup<GROUP, cnine::CtensorObj> &F) {
