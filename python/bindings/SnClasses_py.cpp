...
pybind11::class_<SnElement>(m, "SnElement",
    ...
    .def_static("identity",
                static_cast<SnElement (*)(int)>(&SnElement::Identity),
                "Return the identity element of Sn.")

    .def("getn", &SnElement::getn, "Return n.")
    .def("__getitem__", static_cast<int (SnElement::*)(const int) const>(
                            &SnElement::operator()))
...
pybind11::class_<SnCClass>(m, "SnCClass", "Conjugacy class of Sn.")
...
pybind11::class_<SnIrrep>(m, "SnIrrep", "Class to represent the irreps of Sn.")
    ...
    .def("__getitem__",
         static_cast<rtensor (SnIrrep::*)(const SnElement &) const>(
             &SnIrrep::operator()))
    .def("__getitem__", [](const SnIrrep &obj,
                           const vector<int> &v) { return obj(SnElement(v)); })
...
pybind11::class_<SnClassFunction>(m, "SnClassFunction", "Class function on Sn.")
    ...
    .def_static("raw", static_cast<SnClassFunction (*)(const int, const int)>(
                           &SnClassFunction::raw))
    .def_static("zero", static_cast<SnClassFunction (*)(const int, const int)>(
                            &SnClassFunction::zero))
    .def_static("ones", static_cast<SnClassFunction (*)(const int, const int)>(
                            &SnClassFunction::ones))
    .def_static("gaussian",
                static_cast<SnClassFunction (*)(const int, const int)>(
                    &SnClassFunction::gaussian),
                py::arg("n"), py::arg("dev") = 0)
    .def_static("sequential",
                static_cast<SnClassFunction (*)(const int, const int)>(
                    &SnClassFunction::sequential))

    .def("__len__", &SnClassFunction::size, "Return the number of classes.")

    .def("__getitem__",
         static_cast<float (SnClassFunction::*)(const int) const>(
             &SnClassFunction::get_value))
    .def("__getitem__",
         static_cast<float (SnClassFunction::*)(const IntegerPartition &)
                         const>(&SnClassFunction::get_value))
    .def("__getitem__",
         static_cast<float (SnClassFunction::*)(const SnCClass &) const>(
             &SnClassFunction::get_value))
    .def("__getitem__",
         [](const SnClassFunction &obj, const vector<int> &v) {
...
pybind11::class_<Sn>(m, "Sn")
    ...
    .def("cclass",
         static_cast<SnCClass (Sn::*)(const int x) const>(&Sn::cclass))
    .def("cclass",
         static_cast<SnCClass (Sn::*)(const IntegerPartition &) const>(
             &Sn::cclass))
    .def("cclass",
         [](const Sn &obj, const vector<int> v) {
           return obj.cclass(IntegerPartition(v));
         })
    .def("index",
         static_cast<int (Sn::*)(const IntegerPartition &) const>(&Sn::index))
    .def("cclass_size",
         static_cast<int (Sn::*)(const IntegerPartition &) const>(
             &Sn::class_size))
    .def("index", static_cast<int (Sn::*)(const SnCClass &) const>(&Sn::index))
    .def("cclass_size",
         static_cast<int (Sn::*)(const SnCClass &) const>(&Sn::class_size))

    .def("nchars", &Sn::nchars)
    .def("character",
         static_cast<SnClassFunction (Sn::*)(const IntegerPartition &) const>(
             &Sn::character))
    .def("character",
         [](const Sn &obj, const vector<int> v) {
...
pybind11::class_<SnType>(m, "SnType", "Class to store the type of an Sn vector")
    .def(pybind11::init<>(), "")
    ...
    .def(
        "__setitem__",
        [](SnType &obj, const vector<int> &v, const int x) {
          obj.set(IntegerPartition(v), x);
        },
        "")

    .def("__str__", &SnType::str, py::arg("indent") = "",
         "Print the SnType to string.");
