...
public:
  ProductGroupElement(const E1 &_e1, const E2 &_e2) : e1(_e1), e2(_e2) {}

public:
  int index() const { return e1.index() * e2.size() + e2.index(); }
...
template <typename E1, typename E2,
          typename = typename std::enable_if<
              std::is_base_of<GroupElement, E1>::value, E1>::type>
